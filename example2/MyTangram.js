...
class MyTangram extends CGFobject {
    ...
    display(){
        ...
        this.scene.rotate(convertAng(180), 0, 0, 1);
        ...
        this.scene.rotate(convertAng(-135), 0, 0, 1);
        this.triangleBig.display();
        this.scene.popMatrix();
        // ORANGE
        this.scene.pushMatrix();
        ...
        this.scene.rotate(convertAng(20), 0, 0, 1);
        ...
        this.scene.rotate(convertAng(45), 0, 0, 1);
